...
-(void)showPhotoLibraryCanEdit:(BOOL)edit photo:(photoBlock)block
{
    ...
    imagePickerController.navigationBar.barTintColor = [UIColor colorWithRed:62.0/255 green:54.0/255 blue:139.0/255 alpha:1.0];
...
-(void)showCameraCanEdit:(BOOL)edit photo:(photoBlock)block
{
    ...
    {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"温馨提示" message:@"\n该设备不支持相机" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
        [alert show];
    }
